...
class TestInstructorDashboard(ModuleStoreTestCase, LoginEnrollmentTestCase, XssTestMixin):
    ...
    def test_no_enrollments(self):
        ...
        self.assertNotIn('<h2 id="header-course_info">Enrollment Information</h2>', response.content)
    ...
    def test_show_enrollments_data(self):
        ...
        self.assertIn('<h2 id="header-course_info">Enrollment Information</h2>', response.content)
