    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_type', models.CharField(max_length=64, choices=[(b'myself', b'Myself'), (b'staff', b'Staff and instructors'), (b'learners', b'All students'), (b'cohort', b'Send to a specific cohort'), (b'all', b'All')])),
            ],
        ),
